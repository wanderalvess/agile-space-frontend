    ...
    <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-[#fafafa]">
      ...
      <div className="relative flex flex-col items-center gap-10">
        ...
        <div className="relative group">
          ...
          <div className="relative z-10 p-6 bg-white/40 backdrop-blur-3xl rounded-[2.5rem] border border-white shadow-2xl shadow-primary/10">
        ...
        <div className="flex flex-col items-center gap-4 text-center px-4 relative z-10">
          <div className="flex items-center gap-4 py-2 px-6 bg-white/60 backdrop-blur-xl border border-white rounded-2xl shadow-xl shadow-slate-200/50">
            <div className="relative">
              <Loader2 className="h-6 w-6 animate-spin text-primary relative z-10" />
              <div className="absolute inset-0 bg-primary/20 blur-md rounded-full animate-pulse" />
            </div>
            <h2 className="text-3xl font-black font-headline uppercase tracking-tighter text-slate-900 italic">
              {message}
            </h2>
          </div>
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <div className="w-56 h-1.5 bg-slate-200/50 rounded-full overflow-hidden relative mt-2 border border-white/50 shadow-inner">
