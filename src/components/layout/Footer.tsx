...
export function Footer({ className, onOpenFeedback }: FooterProps) {
  return (
    <footer className={cn(
      ...
      {/* Navigation links */}
      <nav className="flex flex-wrap items-center justify-center gap-1.5 md:gap-3 relative z-10" aria-label="Links úteis do rodapé">
        {onOpenFeedback && (
          <button 
          ...
          >
            <MessageSquareHeart className="h-3 w-3" aria-hidden="true" /> Feedback
          </button>
        )}
