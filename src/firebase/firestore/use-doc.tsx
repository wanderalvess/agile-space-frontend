  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(
      ...
      (error: FirestoreError) => {
        ...
        // Só propaga o erro globalmente se o usuário estiver autenticado.
        // Evita derrubar a árvore React em transições normais (ex: logout)
        // onde a negação de permissão é esperada.
